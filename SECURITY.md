...
- `docs/enterprise/PRODUCT_SECURITY_WHITE_PAPER.md` — honest positioning: integrity enforcement for
  enrolled assets; explicitly not an antivirus replacement.
...
- DFIM is a deterministic integrity-enforcement control for explicitly enrolled assets, not an
  antivirus replacement. It performs no malware or entropy classification, does not block
  unenrolled files, and cannot distinguish a malicious change from a legitimate update. See
  `docs/enterprise/PRODUCT_SECURITY_WHITE_PAPER.md`.
