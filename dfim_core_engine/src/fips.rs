...
static FIPS_MODE: core::sync::atomic::AtomicU8 =
    core::sync::atomic::AtomicU8::new(FIPS_MODE_SOFTWARE);
...
mod tests {
    ...
    fn fips_kat_sha256_empty_passes() {
        ...
        assert!(crate::crypto::constant_time_hash_eq(
            &h,
            &SHA256_KAT_EMPTY_EXPECTED
        ));
    }
