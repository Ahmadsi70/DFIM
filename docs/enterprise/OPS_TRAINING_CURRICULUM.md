...
| 5. Telemetry | 60 min | `DFIM_TELEMETRY_OUT`, Collector, Grafana ops stack, offline HTML report | Tail JSONL + generate report |
...
- JSONL event observed in SIEM, local Loki dashboard, or offline HTML report
